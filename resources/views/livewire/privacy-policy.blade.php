<div class="space-y-8">
    <header class="space-y-4 animate-fade-up">
        <div class="inline-flex items-center gap-2 rounded-full border border-emerald-200/70 bg-emerald-100/70 px-3 py-1 text-xs font-semibold uppercase tracking-wide text-emerald-700 dark:border-emerald-500/40 dark:bg-emerald-500/10 dark:text-emerald-200">
            ...
            {{ __('app.settings.legal') }}
        </div>
        <h1 class="text-3xl font-semibold tracking-tight text-slate-900 dark:text-white">{{ __('app.settings.privacy_policy') }}</h1>
        <p class="text-slate-600 dark:text-slate-400">{{ __('app.settings.privacy_policy_help') }}</p>
    </header>

    <div class="app-card-strong p-6 space-y-6 animate-fade-up animation-delay-150">
        <div class="space-y-3">
            <p class="text-sm uppercase tracking-[0.2em] text-slate-500 dark:text-slate-400">Effective date</p>
            <p class="text-lg font-semibold text-slate-900 dark:text-white">{{ $effectiveDate }}</p>
        </div>

        <div class="rounded-2xl border border-emerald-200/70 bg-emerald-50/80 p-4 text-sm text-emerald-900 shadow-sm dark:border-emerald-500/30 dark:bg-emerald-500/10 dark:text-emerald-100">
            <p>
        ...
        <section class="space-y-3">
            <h2 class="text-xl font-semibold text-slate-900 dark:text-white">Information we collect</h2>
            ...
            <ul class="grid gap-2 text-slate-600 dark:text-slate-300">
        ...
        <section class="space-y-3">
            <h2 class="text-xl font-semibold text-slate-900 dark:text-white">How we use information</h2>
            <p class="text-slate-600 dark:text-slate-300">
        ...
        <section class="space-y-3">
            <h2 class="text-xl font-semibold text-slate-900 dark:text-white">Data storage and security</h2>
            <p class="text-slate-600 dark:text-slate-300">
        ...
        <section class="space-y-3">
            <h2 class="text-xl font-semibold text-slate-900 dark:text-white">Third-party services</h2>
            <p class="text-slate-600 dark:text-slate-300">
            ...
            <p class="text-slate-600 dark:text-slate-300">
                ...
                <a class="font-semibold text-slate-900 underline decoration-emerald-300/80 underline-offset-4 dark:text-white dark:decoration-emerald-400/60" href="https://policies.google.com/privacy" target="_blank" rel="noopener noreferrer">https://policies.google.com/privacy</a>.
            </p>
        </section>
        ...
        <section class="space-y-3">
            ...
            <ul class="grid gap-2 text-slate-600 dark:text-slate-300">
                <li><span class="font-semibold text-slate-900 dark:text-white">Network state</span>: Used to check your device's internet connectivity status. This permission does not allow the app to access your network traffic or transmit any data.</li>
            </ul>
            <p class="text-slate-600 dark:text-slate-300">
        ...
        <section class="space-y-3">
            <h2 class="text-xl font-semibold text-slate-900 dark:text-white">Data retention and deletion</h2>
            <p class="text-slate-600 dark:text-slate-300">
        ...
        <section class="space-y-3">
            <h2 class="text-xl font-semibold text-slate-900 dark:text-white">Sharing of information</h2>
            <p class="text-slate-600 dark:text-slate-300">
        ...
        <section class="space-y-3">
            <h2 class="text-xl font-semibold text-slate-900 dark:text-white">Your rights</h2>
            <p class="text-slate-600 dark:text-slate-300">
                You have the following rights regarding your data:
            </p>
            <ul class="grid gap-2 text-slate-600 dark:text-slate-300">
                <li><span class="font-semibold text-slate-900 dark:text-white">Right to access</span>: You can view all your data directly within the app</li>
                <li><span class="font-semibold text-slate-900 dark:text-white">Right to deletion</span>: You can delete any subscription or uninstall the app to remove all data</li>
                <li><span class="font-semibold text-slate-900 dark:text-white">Right to data portability</span>: Since data is stored locally, you have full control and can export it if needed</li>
            </ul>
            <p class="text-slate-600 dark:text-slate-300">
        ...
        <section class="space-y-3">
            <h2 class="text-xl font-semibold text-slate-900 dark:text-white">Children's privacy</h2>
            <p class="text-slate-600 dark:text-slate-300">
        ...
        <section class="space-y-3">
            <h2 class="text-xl font-semibold text-slate-900 dark:text-white">International users</h2>
            <p class="text-slate-600 dark:text-slate-300">
        ...
        <section class="space-y-3">
            <h2 class="text-xl font-semibold text-slate-900 dark:text-white">Changes to this policy</h2>
            <p class="text-slate-600 dark:text-slate-300">
        ...
        <section class="space-y-3">
            <h2 class="text-xl font-semibold text-slate-900 dark:text-white">Contact</h2>
            <p class="text-slate-600 dark:text-slate-300">
                If you have questions, concerns, or requests regarding this privacy policy or your data, please contact us:
            </p>
            <ul class="grid gap-2 text-slate-600 dark:text-slate-300">
                <li><span class="font-semibold text-slate-900 dark:text-white">Developer</span>: Dimitar Yanakiev</li>
                <li><span class="font-semibold text-slate-900 dark:text-white">Email</span>: app@webticus.com</li>
                <li><span class="font-semibold text-slate-900 dark:text-white">Support Email</span>: app@webticus.com</li>
            </ul>
        </section>
    </div>
</div>
